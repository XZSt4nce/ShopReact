...
contract Store is IShop, IUsers {
    ...
    mapping (address => CartProduct[]) private ownership;
    mapping (string => CartProduct) private titleToCartProduct;
    ...
    function getOwnProducts() external view returns(CartProduct[] memory) {
